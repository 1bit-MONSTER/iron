...
def my_upsample(dev, height, width, channels, scale_factor, num_columns):
    """ObjectFIFO design for nearest-neighbor 2x upsampling on NPU.
    ...
    Args:
        ...
        scale_factor: Upsampling scale factor (must be 2).
    ...
    # ObjectFIFOs -- single column design for now
    # Input: depth=2 for double buffering
    # Output: depth=2 for double buffering
