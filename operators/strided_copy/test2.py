...
transpose_concat = AIEStridedCopy(
    input_sizes=(1, num_heads, prompt_len, head_dim,),
    input_strides=(0, head_dim, num_heads * head_dim, 1,),
    input_offset=0,
...
value_cache_1.view_as_torch()[:, :cached_prompt_len, :] = torch.randn(num_heads, cached_prompt_len, head_dim)
value_1.view_as_torch()[:prompt_len, :, :] = torch.randn(prompt_len, num_heads, head_dim)
