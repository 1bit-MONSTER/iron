...
def my_eltwise_add(dev, num_elements, num_columns, tile_size, trace_size, archive_name):
    ...
    eltwise_add_bf16_vector = Kernel(
        "eltwise_add_bf16_vector", archive_name, [tile_ty, tile_ty, tile_ty, np.int32]
    )
